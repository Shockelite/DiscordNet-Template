...
namespace Discord.CommandClassic {
    ...
    public class CommandClassicBase : CommandBase {
        ...
        /// <inheritdoc cref="CommandClassicFlags.Break"/>
        private bool _conditionBreak;

        /// <inheritdoc cref="CommandClassicFlags.Break"/>
        public bool ConditionBreak {
            get => _conditionBreak;
            protected set {
                _conditionBreak = value;
                Flags = value
                    ? Flags | CommandClassicFlags.Break
                    : Flags & ~CommandClassicFlags.Break;
            }
        }
        ...
        /// </summary>
        /// <param name="contextType">If this command can be used outside of guilds.</param>
        ...
        /// <param name="doBreak">If enabled, stop executing other matched classic commands.</param>
        public CommandClassicBase(CommandContextType contextType = CommandContextType.None, string? equals = null, string? startsWith = null, string? contains = null, string? endsWith = null, Regex? regex = null, float random = 1f, bool doBreak = false) : base(contextType) {
